                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-block">
                                <button class="btn btn-navy rounded-pill btn-sm" type="button" onclick="window.location.href='<?php echo url("backend/giftset/form");?>';">
                                    <i class="ion-plus"></i>
                                </button>
                                <p>&nbsp;</p>
                                <div class="dt-responsive table-responsive">
                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                        ...
                                        @if(!empty($rows))
                                            ...
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td><img src="../{{$r->giftset_image}}" width="200"></td>
                                                <td>{{$r->giftset_name}}</td>
                                                <td><a href="{{url('backend/giftset/form/'.$r->giftset_id)}}">Edit</a> / <a href="{{url('backend/giftset/delete/'.$r->giftset_id)}}" onclick="return confirm('Confirm Delete');">Delete</a></td>
                                            </tr>
                                            @endforeach
                                        @endif
                                        @if($i == 0)
