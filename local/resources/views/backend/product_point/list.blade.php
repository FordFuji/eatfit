                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-block">
                                <button class="btn btn-navy rounded-pill btn-sm" type="button" onclick="window.location.href='{{url("backend/product_point/form")}}';">
                                    <i class="ion-plus"></i>
                                </button>
                                <p>&nbsp;</p>
                                    ...
                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                        ...
                                        @if(!empty($promocode))
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{url('backend/promocode/form/'.$r->order_detail_id)}}">Edit</a> / <a href="{{url('backend/promocode/delete/'.$r->order_detail_id)}}">Edit</a></td>
                                            </tr>
                                            @endforeach
                                        @endif
                                        @if($i == 0)
