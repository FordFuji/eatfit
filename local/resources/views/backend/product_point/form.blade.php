                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="products_id" id="produts_id" class="form-control select2" required>
                                                    <option value="">Please Select</option>
@if(!empty($products))
    @foreach($products as $r)
                                                    <option value="{{$r->products_id}}" {{(!empty($row) and $row->products_id == $r->products_id) ? 'selected' : ''}}>{{$r->name_products_thai.' / '.$r->name_products_eng}}</option>
    @endforeach
@endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="product_point" value="{{(!empty($row)) ? $row->product_point : ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
