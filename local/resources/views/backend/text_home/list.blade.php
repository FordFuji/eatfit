                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-block">
                                <button class="btn btn-navy rounded-pill btn-sm" type="button" onclick="window.location.href='<?php echo url("backend/text_home_form/");?>';">
                                    <i class="ion-plus"></i>
                                </button>
                                <p>&nbsp;</p>
                                <div class="dt-responsive table-responsive">
                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                        ...
                                        @if(!empty($rows))
                                            ...
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$r->text_home_th}}</td>
                                                <td>{{$r->text_home_en}}</td>
                                                <td><a href="{{url('backend/text_home_form/'.$r->text_home_id)}}">Edit</a> / <a href="{{url('backend/deleteTextHome/'.$r->text_home_id)}}" onclick="return confirm('Confirm Delete');">Delete</a></td>
                                            </tr>
                                            @endforeach
                                        @endif
                                        @if($i == 0)
