                                                ...
                                                <td>
                                                    <div class="dropdown-blue dropdown open ">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdown-2"
                                                            ...
                                                            <form action="{{url('/savepay', $item->order_id)}}" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="order_satatus" value="Pay">
                                                                <button class="dropdown-item waves-light waves-effect" type="submit">
                                                                    <i class="icon-credit-card"></i>Payment Accepted</button>
                                                            </form>
