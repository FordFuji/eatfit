                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-block">
                                <button class="btn btn-navy rounded-pill btn-sm" type="button" onclick="window.location.href='<?php echo url("backend/instagram/form");?>';">
                                    <i class="ion-plus"></i>
                                </button>
                                <p>&nbsp;</p>
                                <div class="dt-responsive table-responsive">
                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                        ...
                                        @if(!empty($instagram))
                                            ...
                                            @endphp
                                            <tr>
                                                <td>{{$r->instagram_id}}</td>
                                                <td><img src="{{ asset($r->instagram_image) }}" width="250"></td>
                                                <td>{{$r->instagram_alt}}</td>
                                                <td><a href="{{url('backend/instagram/form/'.$r->instagram_id)}}">Edit</a> / <a href="{{url('backend/instagram/delete/'.$r->instagram_id)}}" onclick="return confirm('Confirm Delete');">Delete</a></td>
                                            </tr>
                                            @endforeach
                                        @endif
                                        @if($i == 0)
