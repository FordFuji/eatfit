            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="topicbar_member">My Profile</div>
                        <div class="topic_member_border">Personal Info</div>
                                ...
                                <div class="col-12 col-md-6">
                                 ...
                                 <div class="col-12 col-md-6">
                                     <div class="form-group">
                                        ...
                                        <input class="form-control form-control-lg" value="piboonkanarak">
                                      </div>
                                 </div>
                                 ...
                                 <div class="row">
                                     <div class="col-12">
                                         <div class="btn_submit_regis">
                                             <button class="btn_default btn_green">update</button>
                                         </div>
                                     </div>
                                 </div>
                             </div>
